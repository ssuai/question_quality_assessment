...
* Download the dataset from [here](https://dqanonymousdata.blob.core.windows.net/neurips-public/data.zip) or clone a [backup repo](https://huggingface.co/datasets/ssuai/question_quality_assessment).
* subfolder structure
